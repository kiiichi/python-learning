# Generated from 'v3_0_1.xml' on 2023-03-13 11:43:30.459345
...
class ServoControlServosNamed:
    ...
    async def enable_all_servos(self) -> None:
        await self.__client.exec(self.__name + ':enable-all-servos', input_stream=None, output_type=None, return_type=None)

    async def disable_all_servos(self) -> None:
        await self.__client.exec(self.__name + ':disable-all-servos', input_stream=None, output_type=None, return_type=None)
...
class CtlMotorCalibration:
    ...
    async def shift_wavelength(self, target_wavelength: float) -> None:
        ...
        await self.__client.exec(self.__name + ':shift-wavelength', target_wavelength, input_stream=None, output_type=None, return_type=None)

    async def reset_shift(self) -> None:
        await self.__client.exec(self.__name + ':reset-shift', input_stream=None, output_type=None, return_type=None)
...
class DLCpro:
    ...
    async def output_signals_report(self) -> None:
        await self.__client.exec('output-signals-report', input_stream=None, output_type=None, return_type=None)
    ...
    async def system_summary_ontimes(self) -> str:
        return await self.__client.exec('system-summary-ontimes', input_stream=None, output_type=str, return_type=None)
