...
ttk.Label(frame, text="Pump pid ival:").grid(column=0, row=1, sticky=tk.W)
ttk.Label(frame, textvariable=p1_pid0_ival).grid(column=1, row=1)
ttk.Label(frame, text="Local pid ival:").grid(column=0, row=2, sticky=tk.W)
ttk.Label(frame, textvariable=p2_pid0_ival).grid(column=1, row=2)
ttk.Label(frame, text="Local pid ival:").grid(column=0, row=3, sticky=tk.W)
ttk.Label(frame, textvariable=p2_pid1_ival).grid(column=1, row=3)

ttk.Label(frame, text="MC pid ival:").grid(column=0, row=4, sticky=tk.W)
...
root.bind('<Control-z>', lambda e: [p3_pid_paused(0), p3_pid_reset(0), p3_ramp_on(0), p3_ramp_off(1)])
root.bind('<Control-n>', lambda e: [p3_ramp_off(0),slow_ramp('on'), p3_pid_unpaused(0)])
root.bind('<Control-m>', lambda e: [slow_ramp('off'), p3_pid_reset(0), p3_pid_unpaused(0)])
