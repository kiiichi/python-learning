...
#============Need to change the channel number and filename================
data = osc_ask_data([3,2], '1M') # data[0] is time, data[1] is voltage, data[2] is power
...
#=============Need to change the fitting curve name================
