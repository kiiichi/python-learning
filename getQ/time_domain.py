...
def osc_ask_data_simple(channels=[1,2,3], file_name=None, /, oscilloscope_address='TCPIP0::192.168.1.9::inst0::INSTR'):
    ...
    if file_name:
        ...
        oscilloscope.write(f':SAVE:IMAGe D:\{file_name}.tiff')1
...
file_name = input("Please enter the name for the CSV file (or press enter to skip saving): ")
osc_ask_data_simple([4], file_name)